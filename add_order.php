        ...
        <div class="row">
            ...
            <tbody>
                <tr  v-for="item in cart">
                    ...
                    <td data-label="Age"> <div class="ui input"> <input min="1" v-bind:value="item.p_QTY" v-on:input="event => update_qty(event,item.p_ID)"  id="gross_amount" value="1" type="number"/></div></td>
                    ...
                    <td data-label="Age">
                    <button @click="remove_item_from_cart(item.p_ID)" data-tooltip="Delete product" data-position="top right" class="ui icon button"><i class="close icon"></i></button>
                    </td>
                </tr>
            ...
            <div class="col-sm-12 col-md-4" style="margin-top:20px">
                ...
                <div class="content">
                   ...
                   <div class="row" style="margin-top:10px">
                       ...
                       <div class='col-sm-8'>
                        <div class="ui input">
                                <input v-model="net_amount" style="background-color:#F1F1F1; font-weight:bolder" readonly id="net_amount" type="text"/>
                            </div>
                       </div>
                   </div>
                ...
                <div class="extra content">
                    <button class="ui button green"  @click="save_order('save')" style="width:100%">Save & Continue</button>
                    <br/><br/>
                    <button class="ui button blue"  @click="save_order('print')" style="width:100%">Save & Print</button>
                </div>
                </div>
            </div>
        </div>
